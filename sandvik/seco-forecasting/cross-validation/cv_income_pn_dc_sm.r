...
# MAGIC %run /Repos/alejandro.kuratomi_hernandez@secotools.com/prophet_R_secotools/sandvik/seco-forecasting/read_data/income/income_read_pn_dc_sm
...
xgb_data_spark <- sdf_copy_to(sc, 
                                 xgb_data,
                                 overwrite = TRUE)
path_out <- paste0("/mnt/blob/hyperparameters/fforma/income/current/data_pn_dc_sm.csv") 
...
xgb_errors_spark <- sdf_copy_to(sc, 
                                 xgb_errors,
                                 overwrite = TRUE)
path_out <- path_out <- paste0("/mnt/blob/hyperparameters/fforma/income/current/errors_pn_dc_sm.csv") 
...
path_out <- paste0("/mnt/blob/hyperparameters/fforma/income/current/xgb_params_pn_dc_sm.csv") 
...
tbl_spark <- sdf_copy_to(sc, 
                                 tbl,
                                 overwrite = TRUE)
path_out <- path_out <- paste0("/mnt/blob/hyperparameters/fforma/income/current/cv_values.csv")
