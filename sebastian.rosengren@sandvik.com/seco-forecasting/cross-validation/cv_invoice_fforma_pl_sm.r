...
# MAGIC %run /Repos/sebastian.rosengren@sandvik.com/seco-forecasting/read_data/invoice/invoice_read_productline_sm
...
hyper <- hp_search(forecast_list, filename = "tmp.RData", n_iter = 10)
...
path_out <- paste0("/mnt/blob/hyperparameters/fforma/invoice/current/xgb_params_pl_sm_wd_feat.csv")
...
xgb_data_spark <- sdf_copy_to(sc, 
                                 xgb_data,
                                 overwrite = TRUE)
path_out <- paste0("/mnt/blob/hyperparameters/fforma/invoice/current/data_pl_sm_wd_feat.csv")
...
xgb_errors_spark <- sdf_copy_to(sc, 
                                 xgb_errors,
                                 overwrite = TRUE)
path_out <- path_out <- paste0("/mnt/blob/hyperparameters/fforma/invoice/current/errors_pl_sm_wd_feat.csv")
...
mlflow_start_run(experiment_id=503359512675401)
