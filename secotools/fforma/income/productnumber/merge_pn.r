...
path_in <- paste0("/mnt/blob/forecast/income/productnumber_dc/", "current", "/pn_dc.csv")
...
path_out_current <- paste0("/mnt/blob/forecast/income/productnumber_dc_sm/current/pn_dc_sm_adj.csv")
path_out_archive <- paste0("/mnt/blob/forecast/income/productnumber_dc_sm/archive/", Sys.Date() %>% str_replace_all("-", "_") ,"/pn_dc_sm_adj.csv")
