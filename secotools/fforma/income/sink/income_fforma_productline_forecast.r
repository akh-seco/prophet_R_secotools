...
path_in <- paste0("/mnt/blob/hyperparameters/fforma/income/current/data.csv")
...
path_in <- paste0("/mnt/blob/hyperparameters/fforma/income/current/errors.csv")
...
path_in <- paste0("/mnt/blob/hyperparameters/fforma/income/current/xgb_params.csv")
...
forecast_spark <- sdf_copy_to(sc, 
                                 forecast_tbl,
                                 overwrite = TRUE)
path_out <- paste0("/mnt/blob/forecast/income/productline/current/pl.csv")
spark_write_csv(forecast_spark, 
                path = path_out, 
                delimiter = ";", 
                mode = "overwrite")
path_out <- paste0("/mnt/blob/forecast/income/productline/archive/", Sys.Date() %>% str_replace_all("-", "_") ,"/pl.csv")
spark_write_csv(forecast_spark, 
                path = path_out, 
                delimiter = ";", 
                mode = "overwrite")
